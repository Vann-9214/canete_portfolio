...
export default function Messages() {
  return (
    <div className="flex flex-col items-center mt-[clamp(0px,17.86vh-142.86px,40px)]">
      ...
      <p className="text-[#2D3436] max-w-[clamp(650px,100vw,1000px)] mt-[clamp(20px,17.86vh-122.86px,60px)] leading-relaxed text-[clamp(12px,1.2vw+6px,18px)] text-center font-jakarta font-normal">
